#!/bin/bash
# Compute voxel overlap metrics (nlin)
...
output_dir=~/graham/project/fid_study_bids/PHASE2/input_data/OAS1_bids_MR1/derivatives/fmriprep_1.1.1/fmriprep_PHASE3_voxel_overlap_nlin/
...
#  echo "---------"
  ...
  input_label_MNI152_thalamusL=${input_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-thalamus-L_roi_nlin.nii.gz
  input_label_MNI152_thalamusR=${input_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-thalamus-R_roi_nlin.nii.gz
  input_label_MNI152_striatumL=${input_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-striatum-L_roi_nlin.nii.gz
  input_label_MNI152_striatumR=${input_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-striatum-R_roi_nlin.nii.gz
  input_label_MNI152_pallidumL=${input_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-pallidum-L_roi_nlin.nii.gz
  input_label_MNI152_pallidumR=${input_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-pallidum-R_roi_nlin.nii.gz

  output_label_MNI152_thalamusL_intersection=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-thalamus-L_roi_nlin_intersection.nii.gz
  output_label_MNI152_thalamusL_union=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-thalamus-L_roi_nlin_union.nii.gz
  output_label_MNI152_thalamusR_intersection=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-thalamus-R_roi_nlin_intersection.nii.gz
  output_label_MNI152_thalamusR_union=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-thalamus-R_roi_nlin_union.nii.gz
  output_label_MNI152_striatumL_intersection=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-striatum-L_roi_nlin_intersection.nii.gz
  output_label_MNI152_striatumL_union=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-striatum-L_roi_nlin_union.nii.gz
  output_label_MNI152_striatumR_intersection=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-striatum-R_roi_nlin_intersection.nii.gz
  output_label_MNI152_striatumR_union=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-striatum-R_roi_nlin_union.nii.gz
  output_label_MNI152_pallidumL_intersection=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-pallidum-L_roi_nlin_intersection.nii.gz
  output_label_MNI152_pallidumL_union=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-pallidum-L_roi_nlin_union.nii.gz
  output_label_MNI152_pallidumR_intersection=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-pallidum-R_roi_nlin_intersection.nii.gz
  output_label_MNI152_pallidumR_union=${output_dir}/${SUBJ}/anat/${SUBJ}_T1w_space-MNI152NLin2009cAsym_label-pallidum-R_roi_nlin_union.nii.gz
